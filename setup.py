...
setup(
    **{
        ...
        'classifiers': [
            'Development Status :: 3 - Alpha', 'Environment :: Console', 'Environment :: No Input/Output (Daemon)', 'Framework :: Twisted', 'Intended Audience :: Developers', 'Intended Audience :: End Users/Desktop',
            'Intended Audience :: Information Technology', 'Intended Audience :: Science/Research', 'Intended Audience :: Telecommunications Industry', 'License :: OSI Approved :: GNU Affero General Public License '
            'v3 or later (AGPLv3+)', 'Natural Language :: English', 'Operating System :: OS Independent', 'Programming Language :: Python', 'Programming Language :: Python :: 2', 'Programming Language :: Python :: 2.7',
            'Programming Language :: Python :: 3', 'Programming Language :: Python :: 3.6', 'Topic :: Communications :: Chat', 'Topic :: Internet :: WWW/HTTP', 'Topic :: Communications :: File Sharing',
            'Topic :: Desktop Environment :: File Managers', 'Topic :: Internet :: File Transfer Protocol (FTP)', 'Topic :: Security :: Cryptography', 'Topic :: System :: Archiving :: Backup', 'Topic :: System :: Distributed Computing',
            'Topic :: System :: Filesystems', 'Topic :: System :: System Shells', 'Topic :: Utilities'
        ],
        ...
        'name': 'bitdust',
        'packages': [
            'access', 'automats', 'blockchain', 'broadcast', 'chat', 'CodernityDB', 'CodernityDB3', 'coins', 'contacts', 'crypt', 'currency', 'customer', 'dht', 'interface', 'lib', 'logs', 'main', 'p2p', 'parallelp', 'raid', 'services', 'storage',
            'stun', 'supplier', 'system', 'tests', 'transport', 'updates', 'userid', 'dht.entangled', 'dht.entangled.kademlia', 'lib.txrestapi', 'lib.txrestapi.txrestapi', 'parallelp.pp', 'transport.http', 'transport.proxy', 'transport.tcp',
            'transport.udp'
        ],
        'tests_require': [],
