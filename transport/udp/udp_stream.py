    ...
    def block_received(self, inpt):
        if self.consumer:
            ...
            if block_id == self.input_block_id + 1:
                ...
                eof_state = self.consumer.on_received_raw_data(self.consumer, newdata)
    ...
    def ack_received(self, inpt):
        if self.consumer:
            ...
            while True:
                ...
                self.consumer.on_sent_raw_data(self.consumer, block_size)
