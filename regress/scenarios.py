...
def scenario4():
    ...
    customer_1_share_info = kw.share_info_v1(
        "customer-1", customer_1_share_id_cat, wait_state="CONNECTED", wait_suppliers=2
    )
    ...
    run_ssh_command_and_wait(
        "customer-2", f"mkdir /customer_2/dog_shared/", verbose=ssh_cmd_verbose
    )
    ...
    customer_1_share_info_2 = kw.share_info_v1(
        "customer-2", customer_1_share_id_cat, wait_state="CONNECTED", wait_suppliers=2
    )
    ...
    (
        customer_2_local_filepath_dog,
        customer_2_remote_path_dog,
        customer_2_download_filepath_dog,
    ) = kw.verify_file_create_upload_start(
        node="customer-2",
        key_id=customer_1_share_id_cat,
...
def scenario8():
    ...
    customer_1_conversations_count_before = len(
        kw.message_conversation_v1("customer-1")["result"]
    )

    # create group owned by customer-1
    kw.service_info_v1("customer-1", "service_private_groups", "ON")
    customer_1_group_key_id = kw.group_create_v1(
        "customer-1", label="SCENARIO8_ArchivedGroup"
    )
    kw.wait_service_state(CUSTOMERS_IDS_123, "service_shared_data", "ON")
    kw.wait_service_state(CUSTOMERS_IDS_123, "service_private_groups", "ON")
    kw.wait_packets_finished(CUSTOMERS_IDS_123 + BROKERS_IDS)

    customer_1_conversations_count_after = len(
        kw.message_conversation_v1("customer-1")["result"]
    )
    assert (
        customer_1_conversations_count_before + 1 == customer_1_conversations_count_after
    )
    ...
    customer_2_conversations_count_before = len(
        kw.message_conversation_v1("customer-2")["result"]
    )
    ...
    customer_2_conversations_count_after = len(
        kw.message_conversation_v1("customer-2")["result"]
    )
    assert (
        customer_2_conversations_count_before + 1 == customer_2_conversations_count_after
    )
    ...
    assert (
        len(kw.message_conversation_v1("customer-1")["result"])
        == customer_1_conversations_count_after
    )
    assert (
        len(kw.message_conversation_v1("customer-2")["result"])
        == customer_2_conversations_count_after
    )
...
def scenario9(target_nodes):
    ...
    if "proxy-rotated" in target_nodes:
        ...
        kw.config_set_v1(
            "proxy-rotated", "services/identity-propagate/preferred-servers", ""
        )
    if "customer-rotated" in target_nodes:
        kw.config_set_v1(
            "customer-rotated",
...
def scenario11_end(
    old_customer_rotated_info, new_customer_rotated_info, old_customer_1_info
):
    ...
    assert (
        len(
            kw.message_history_v1(
                "customer-1",
                "master$customer-rotated@id-a_8084",
                message_type="private_message",
            )["result"]
        )
        == 1
...
def scenario12_begin():
    ...
    customer_1_group_key_id = kw.group_create_v1(
        "customer-1", label="SCENARIO12_MyGroupABC"
    )
    kw.wait_service_state(CUSTOMERS_IDS_12, "service_shared_data", "ON")
    kw.wait_service_state(CUSTOMERS_IDS_12, "service_private_groups", "ON")
    ...
    customer_1_group_info_dht_customer_1 = kw.group_info_dht_v1(
        "customer-1", customer_id="customer-1@id-a_8084", wait_records=3
    )
    assert (
        customer_1_group_info_dht_customer_1["result"][0]["broker_idurl"]
        == "http://id-dead:8084/broker-rotated.xml"
    )
    assert (
        customer_1_group_info_dht_customer_1["result"][1]["broker_idurl"]
        == "http://id-a:8084/broker-3.xml"
    )
    assert (
        customer_1_group_info_dht_customer_1["result"][2]["broker_idurl"]
        == "http://id-b:8084/broker-4.xml"
    )

    customer_1_group_info_dht_customer_rotated = kw.group_info_dht_v1(
        "customer-2", customer_id="customer-1@id-a_8084", wait_records=3
    )
    assert (
        customer_1_group_info_dht_customer_rotated["result"][0]["broker_idurl"]
        == "http://id-dead:8084/broker-rotated.xml"
    )
    assert (
        customer_1_group_info_dht_customer_rotated["result"][1]["broker_idurl"]
        == "http://id-a:8084/broker-3.xml"
    )
    assert (
        customer_1_group_info_dht_customer_rotated["result"][2]["broker_idurl"]
        == "http://id-b:8084/broker-4.xml"
    )
    ...
    customer_1_group2_key_id = kw.group_create_v1(
        "customer-1", label="SCENARIO12_MyGroupXYZ"
    )
    kw.wait_service_state(CUSTOMERS_IDS_12, "service_shared_data", "ON")
    kw.wait_service_state(CUSTOMERS_IDS_12, "service_private_groups", "ON")
    kw.wait_packets_finished(CUSTOMERS_IDS_12 + BROKERS_IDS)
    ...
    assert (
        kw.group_info_v1("customer-1", customer_1_group_key_id, wait_state="IN_SYNC!")[
            "result"
        ]["state"]
        == "IN_SYNC!"
    )
    assert (
        kw.group_info_v1("customer-1", customer_1_group2_key_id, wait_state="IN_SYNC!")[
            "result"
        ]["state"]
        == "IN_SYNC!"
    )
    ...
    assert (
        kw.group_info_v1("customer-1", customer_1_group2_key_id)["result"][
            "last_sequence_id"
        ]
        == 5
    )
    ...
    assert (
        len(
            kw.message_history_v1(
                "customer-1", customer_1_group2_key_id, message_type="group_message"
            )["result"]
        )
        == 6
    )
...
def scenario12_end(old_customer_1_info):
    ...
    if customer_2_group_info_before["state"] == "DISCONNECTED":
        ...
        customer_2_group_info_before = kw.group_info_v1(
            "customer-2", customer_1_group_key_id, wait_state="IN_SYNC!"
        )["result"]
    ...
    customer_2_group2_info_before = kw.group_info_v1(
        "customer-2", customer_1_group2_key_id, wait_state="IN_SYNC!"
    )["result"]
    ...
    customer_1_group_info_before = kw.group_info_v1(
        "customer-1", customer_1_group_key_id, wait_state="IN_SYNC!"
    )["result"]
    assert customer_1_group_info_before["state"] == "IN_SYNC!"
    customer_1_group2_info_before = kw.group_info_v1(
        "customer-1", customer_1_group2_key_id, wait_state="IN_SYNC!"
    )["result"]
    ...
    assert customer_1_old_queue_id not in kw.queue_list_v1(
        customer_2_rotated_broker_name, extract_ids=True
    )

    # verify customer-1 is still connected to the group
    customer_1_group_info_rotated = kw.group_info_v1(
        "customer-1", customer_1_group_key_id, wait_state="IN_SYNC!"
    )["result"]
    ...
    assert customer_1_rotated_queue_id in kw.queue_list_v1(
        customer_1_rotated_broker_name, extract_ids=True
    )
    assert customer_1_old_queue_id not in kw.queue_list_v1(
        customer_1_rotated_broker_name, extract_ids=True
    )
    ...
    assert customer_1_old_queue_id not in kw.queue_peddler_list_v1(
        customer_2_rotated_broker_name, extract_ids=True
    )
    assert customer_1_rotated_queue_id in kw.queue_peddler_list_v1(
        customer_2_rotated_broker_name, extract_ids=True
    )

    # verify new broker accepted customer-1
    customer_1_rotated_broker_consumers = kw.queue_consumer_list_v1(
        customer_1_rotated_broker_name, extract_ids=True
    )
    ...
    customer_1_rotated_broker_producers = kw.queue_producer_list_v1(
        customer_1_rotated_broker_name, extract_ids=True
    )
    ...
    customer_1_rotated_broker_keepers = kw.queue_keeper_list_v1(
        customer_1_rotated_broker_name, extract_ids=True
    )
    ...
    assert (
        kw.group_info_v1("customer-2", customer_1_group_key_id, wait_state="IN_SYNC!")[
            "result"
        ]["state"]
        == "IN_SYNC!"
    )
    assert (
        kw.group_info_v1("customer-2", customer_1_group2_key_id, wait_state="IN_SYNC!")[
            "result"
        ]["state"]
        == "IN_SYNC!"
    )
    ...
    customer_1_broker_consumers = kw.queue_consumer_list_v1(
        customer_1_old_broker_name, extract_ids=True
    )
    customer_1_broker_producers = kw.queue_producer_list_v1(
        customer_1_old_broker_name, extract_ids=True
    )
    ...
    assert customer_1_rotated_queue_id not in kw.queue_peddler_list_v1(
        customer_1_old_broker_name, extract_ids=True
    )
...
def scenario13_begin():
    ...
    old_customer_1_suppliers_idurls = kw.supplier_list_v1(
...
def scenario13_end(old_customer_1_info):
    ...
    run_ssh_command_and_wait(
        "customer-1",
        "rm -rfv %s" % old_customer_1_info["download_filepath"],
        verbose=ssh_cmd_verbose,
    )[0].strip()
...
def scenario14(old_customer_1_info, customer_1_shared_file_info):
    ...
    while True:
        ...
        while True:
            ...
            assert (
                customer_1_supplier_idurls_after[1] == customer_1_supplier_idurls_after[1]
            )
            if (
                customer_1_supplier_idurls_before[0]
                != customer_1_supplier_idurls_after[0]
            ):
                success = True
                break
            count += 1
        ...
        response = request_post(
            "customer-1", "supplier/change/v1", json={"position": "0"}
        )
        assert response.status_code == 200
        assert response.json()["status"] == "OK", response.json()
        kw.wait_packets_finished(PROXY_IDS + SUPPLIERS_IDS + CUSTOMERS_IDS_12)
...
def scenario16():
    ...
    customer_1_supplier_idurls_increase = kw.supplier_list_v1(
        "customer-1", expected_min_suppliers=4, expected_max_suppliers=4
    )
    ...
    customer_1_supplier_idurls_decrease = kw.supplier_list_v1(
        "customer-1", expected_min_suppliers=2, expected_max_suppliers=2
    )
...
def scenario17(old_customer_1_info, old_customer_2_info):
    ...
    kw.file_list_all_v1(
        "customer-restore", expected_reliable=100, reliable_shares=False, attempts=20
    )
...
def scenario18():
    ...
    customer_2_groupA_key_id = kw.group_create_v1(
        "customer-2", label="SCENARIO18_MyGroupAAA"
    )
    kw.wait_service_state(CUSTOMERS_IDS_123, "service_shared_data", "ON")
    kw.wait_service_state(CUSTOMERS_IDS_123, "service_private_groups", "ON")
    kw.wait_packets_finished(CUSTOMERS_IDS_123 + BROKERS_IDS)
    ...
    customer_2_groupB_key_id = kw.group_create_v1(
        "customer-2", label="SCENARIO18_MyGroupBBB"
    )
    kw.wait_service_state(CUSTOMERS_IDS_123, "service_shared_data", "ON")
    kw.wait_service_state(CUSTOMERS_IDS_123, "service_private_groups", "ON")
    kw.wait_packets_finished(CUSTOMERS_IDS_123 + BROKERS_IDS)
    ...
    customer_1_groupA_info_before = kw.group_info_v1(
        "customer-1", customer_2_groupA_key_id
    )["result"]
    ...
    customer_1_active_broker_name_before = customer_1_active_broker_id_before.split("@")[
        0
    ]
    assert customer_1_active_broker_name_before == "broker-1"

    # also check the second group have similar info for customer-1
    customer_1_groupB_info_before = kw.group_info_v1(
        "customer-1", customer_2_groupB_key_id
    )["result"]
    ...
    assert (
        customer_1_active_broker_id_before
        == customer_1_groupA_info_before["active_broker_id"]
    )
    assert (
        customer_1_active_broker_id_before
        == customer_1_groupB_info_before["active_broker_id"]
    )
    assert (
        customer_1_active_broker_id_before
    ...
    assert (
        ...
        == customer_1_groupA_info_before["connected_brokers"]["0"]
    )
    assert (
        customer_2_groupA_info_before["connected_brokers"]["1"]
        == customer_1_groupA_info_before["connected_brokers"]["1"]
    )
    assert (
        customer_2_groupA_info_before["connected_brokers"]["2"]
        == customer_1_groupA_info_before["connected_brokers"]["2"]
    )
    assert (
    ...
    assert (
        customer_2_groupB_info_before["connected_brokers"]["0"]
        == customer_1_groupB_info_before["connected_brokers"]["0"]
    )
    assert (
        customer_2_groupB_info_before["connected_brokers"]["1"]
        == customer_1_groupB_info_before["connected_brokers"]["1"]
    )
    assert (
        customer_2_groupB_info_before["connected_brokers"]["2"]
        == customer_1_groupB_info_before["connected_brokers"]["2"]
    )
    ...
    customer_1_groupB_info_after = kw.group_info_v1(
        "customer-1", customer_2_groupB_key_id
    )["result"]
    ...
    customer_1_groupA_info_after = kw.group_info_v1(
        "customer-1", customer_2_groupA_key_id, wait_state="IN_SYNC!"
    )["result"]
    assert customer_1_groupA_info_after["state"] == "IN_SYNC!"
    assert len(customer_1_groupA_info_after["connected_brokers"]) >= 2
    assert (
        customer_1_active_broker_id_after
        == customer_1_groupA_info_after["active_broker_id"]
    )
    ...
    assert (
        customer_1_groupA_info_after["connected_brokers"]["0"]
        == customer_1_groupA_info_before["connected_brokers"]["1"]
    )
    assert (
        customer_1_groupA_info_after["connected_brokers"]["1"]
        == customer_1_groupA_info_before["connected_brokers"]["2"]
    )
    assert (
        customer_1_groupA_info_after["connected_brokers"]["2"]
        != customer_1_groupA_info_before["connected_brokers"]["2"]
    )
    assert (
        customer_1_groupB_info_after["connected_brokers"]["0"]
        == customer_1_groupB_info_before["connected_brokers"]["1"]
    )
    assert (
        customer_1_groupB_info_after["connected_brokers"]["1"]
        == customer_1_groupB_info_before["connected_brokers"]["2"]
    )
    assert (
        customer_1_groupB_info_after["connected_brokers"]["2"]
        != customer_1_groupB_info_before["connected_brokers"]["2"]
    )
    assert (
    ...
    assert (
        customer_1_active_broker_id_after
        == customer_1_groupB_info_after["active_broker_id"]
    )
    assert (
        customer_1_active_broker_id_after
...
def scenario20():
    ...
    # create new group by customer-2
    customer_2_groupA_key_id = kw.group_create_v1(
        "customer-2", label="SCENARIO20_MyGroupCCC"
    )
    kw.wait_service_state(CUSTOMERS_IDS_123, "service_shared_data", "ON")
    kw.wait_service_state(CUSTOMERS_IDS_123, "service_private_groups", "ON")
    kw.wait_packets_finished(CUSTOMERS_IDS_123 + BROKERS_IDS)
    ...
    customer_2_groupA_info_before = kw.group_info_v1(
        "customer-3", customer_2_groupA_key_id
    )["result"]
    assert customer_2_groupA_info_before["state"] == "IN_SYNC!"
    ...
    customer_2_groupA_info_after = kw.group_info_v1(
        "customer-3", customer_2_groupA_key_id, wait_state="IN_SYNC!"
    )["result"]
    assert customer_2_groupA_info_after["state"] == "IN_SYNC!"
...
def scenario21():
    ...
    while True:
        if counter >= 20:
            raise Exception(
                "some of queue keepers on broker-1 are still pending after many attempts"
            )
...
def scenario22():
    ...
    customer_1_group_key_id = kw.group_create_v1(
        "customer-1", label="SCENARIO22_MyGroupDDD"
    )
    kw.wait_service_state(CUSTOMERS_IDS_123, "service_shared_data", "ON")
    kw.wait_service_state(CUSTOMERS_IDS_123, "service_private_groups", "ON")
    kw.wait_packets_finished(CUSTOMERS_IDS_123 + BROKERS_IDS)
    ...
    customer_1_group_info = kw.group_info_v1("customer-1", customer_1_group_key_id)[
        "result"
    ]
    ...
    while True:
        if counter >= 20:
            raise Exception(
                "some of queue keepers on the active broker %r are still pending after many attempts"
                % active_broker_name
            )
...
def scenario23(customer_1_file_info, customer_1_shared_file_info):
    ...
    customer_1_suppliers = kw.supplier_list_v1(
        "customer-1",
        expected_min_suppliers=2,
        expected_max_suppliers=2,
        extract_suppliers=True,
