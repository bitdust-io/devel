...
class APIResourceTest(unittest.TestCase):
    ...
    def test_all(self):
        ...
        for method in (b("GET"), b("PUT"), b("ALL")):
            ...
            self.assertEqual(
                result.render(req), b("ALL") if method == b("PUT") else method
            )
...
class JSONAPIResourceTest(APIResourceTest):
    ...
    def test_all(self):
        ...
        for method in (b("GET"), b("PUT"), b("ALL")):
            ...
            result = r.getChild(b("path"), req)
            self.assertEqual(
                json.loads(result.render(req))["method"],
                b("ALL") if method == b("PUT") else method,
            )
    ...
    def test_args(self):
        ...
        result = r.getChild(b("regex"), req)
        self.assertEqual(
            sorted(json.loads(result.render(req))["kwargs"].keys()), ["a", "b"]
        )
