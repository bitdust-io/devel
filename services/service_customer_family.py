            ...
            reactor.callLater(
                ...
                {  # @UndefinedVariable
                    ...
                    "family_snapshot": id_url.to_bin_list(
                        local_customer_meta_info.get("family_snapshot")
                    ),
                },
            )
        events.add_subscriber(self._on_identity_url_changed, "identity-url-changed")
        events.add_subscriber(
            self._on_existing_customer_accepted, "existing-customer-accepted"
        )
        events.add_subscriber(self._on_new_customer_accepted, "new-customer-accepted")
        events.add_subscriber(
            self._on_existing_customer_terminated, "existing-customer-terminated"
        )
        return True
