...
def defaults():
    return {
        ...
        'services/blockchain/port': TYPE_NON_ZERO_POSITIVE_INTEGER,
        'services/blockchain/explorer/enabled': TYPE_BOOLEAN,
        'services/blockchain/explorer/port': TYPE_NON_ZERO_POSITIVE_INTEGER,
        'services/blockchain/wallet/enabled': TYPE_BOOLEAN,
        'services/blockchain/wallet/port': TYPE_NON_ZERO_POSITIVE_INTEGER,
        ...
        'services/http-connections/http-port': TYPE_POSITIVE_INTEGER,
        ...
        'services/identity-server/tcp-port': TYPE_POSITIVE_INTEGER,
        'services/identity-server/web-port': TYPE_POSITIVE_INTEGER,
