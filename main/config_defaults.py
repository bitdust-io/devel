...
def reset(conf_obj):
    ...
    conf_obj.setDefaultValue(
        "interface/api/rest-http-port", settings.DefaultRESTHTTPPort()
    )

    conf_obj.setDefaultValue("interface/api/web-socket-enabled", "true")
    conf_obj.setDefaultValue(
        "interface/api/web-socket-port", settings.DefaultWebSocketPort()
    )
    ...
    conf_obj.setDefaultValue(
        "personal/private-key-size", settings.DefaultPrivateKeySize()
    )
    ...
    conf_obj.setDefaultValue(
        "services/customer/suppliers-number", settings.DefaultDesiredSuppliers()
    )
    ...
    conf_obj.setDefaultValue(
        "services/http-connections/http-port", settings.DefaultHTTPPort()
    )
    ...
    conf_obj.setDefaultValue(
        "services/identity-server/tcp-port", settings.IdentityServerPort()
    )
    conf_obj.setDefaultValue(
        "services/identity-server/web-port", settings.IdentityWebPort()
    )
    ...
    conf_obj.setDefaultValue(
        "services/network/receive-limit", settings.DefaultBandwidthInLimit()
    )
    conf_obj.setDefaultValue(
        "services/network/send-limit", settings.DefaultBandwidthOutLimit()
    )
    ...
    conf_obj.setDefaultValue(
        "services/private-messages/acknowledge-unread-messages-enabled", "true"
    )
    ...
    conf_obj.setDefaultValue(
        "services/tcp-connections/tcp-port", settings.DefaultTCPPort()
    )
