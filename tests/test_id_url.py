...
class TestIDURL(TestCase):
    ...
    def test_identity_cached(self):
        ...
        self.assertEqual(
            id_url.field(alice_bin).to_public_key(), alice_identity.getPublicKey()
        )
    ...
    def test_fake_name(self):
        ...
        self.assertNotEqual(
            id_url.field(fake_frank).original(), id_url.field(frank_1).original()
        )
        self.assertNotEqual(
            id_url.field(fake_frank).original(), id_url.field(frank_2).original()
        )
        ...
        self.assertNotEqual(
            id_url.field(fake_frank).to_public_key(),
            id_url.field(frank_1).to_public_key(),
        )
        self.assertEqual(
            id_url.field(fake_frank).to_public_key(),
            id_url.field(frank_2).to_public_key(),
        )
    ...
    def test_latest_vs_original(self):
        ...
        self.assertNotEqual(
            id_url.field(hans1).original(), id_url.field(hans2).original()
        )
        self.assertEqual(id_url.field(hans1), id_url.field(hans3))
        self.assertNotEqual(
            id_url.field(hans1).original(), id_url.field(hans3).original()
        )
        self.assertEqual(id_url.field(hans3), id_url.field(hans2))
        self.assertNotEqual(
            id_url.field(hans3).original(), id_url.field(hans2).original()
        )
