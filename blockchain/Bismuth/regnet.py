...
SQL_LEDGER = [
    'CREATE TABLE misc (block_height INTEGER, difficulty TEXT)', 'CREATE TABLE transactions (block_height INTEGER, timestamp NUMERIC, address TEXT, recipient TEXT, \
               amount NUMERIC, signature TEXT, public_key TEXT, block_hash TEXT, fee NUMERIC, reward NUMERIC, \
               operation TEXT, openfield TEXT)', "INSERT INTO transactions (openfield, operation, reward, fee, block_hash, public_key, signature, \
               ...
               0, '4edadac9093d9326ee4b17f869b14f1a2534f96f9c5d7b48dc9acaed', 'genesis', 1493640955.47, 1);", 'INSERT INTO misc (difficulty, block_height) VALUES ({},1)'.format(REGNET_DIFF)
]
